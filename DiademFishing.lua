...
-- When do you want to repair your own gear? From 0-100.
  SelfRepair = true -- SelfRepair : true | false (default is true)
  StopTheScripIfThereIsNoDarkMatter = false -- StopTheScripIfThereIsNoDarkMatter : true | false (default is false)
  RepairAmount = 99 -- RepairAmount : Number between 1 to 99 
  
  -- If you would like to use food while in diadem, and what kind of food you would like to use.
  UseFood = true -- UseFood : true | false (default is true)
  StopTheScripIfThereIsNoFood = false -- StopTheScripIfThereIsNoFood : true | false (default is false)
  FoodKind = "Jhinga Curry <HQ>" -- FoodKind : "Jhinga Curry <HQ>" (make sure to have the name of the food IN the "")
  
  -- Preset settings here
  AutoHookPreset = "Sweatfish" -- AutoHookPreset : "your preset name" get it from AutoHook if you changed it.
  HowManyMinutes = 20     -- HowManyMinutes : this setting is to move every x minutes.
